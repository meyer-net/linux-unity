...
PRJ_DIR=${SYNC_DIR}/projects
WWW_DIR=${SYNC_DIR}/wwwroot
WWW_BOOTS_DIR=${WWW_DIR}/boots
WWW_BOOTS_NGX_DIR=${WWW_BOOTS_DIR}/nginx
WWW_BOOTS_ORT_DIR=${WWW_BOOTS_DIR}/openresty
WWW_BOOTS_CDY_DIR=${WWW_BOOTS_DIR}/caddy
WWW_BOOTS_DOC_DIR=${WWW_BOOTS_DIR}/docker
WWW_INIT_DIR=${WWW_DIR}/init
WWW_INIT_MSQ_DIR=${WWW_INIT_DIR}/mysql
WWW_INIT_MDB_DIR=${WWW_INIT_DIR}/mariadb
WWW_INIT_PSQ_DIR=${WWW_INIT_DIR}/postgresql
WWW_INIT_MGDB_DIR=${WWW_INIT_DIR}/mongodb
WWW_INIT_CH_DIR=${WWW_INIT_DIR}/clickhouse
WWW_LANG_DIR=${WWW_DIR}/lang
WWW_LANG_LUA_DIR=${WWW_LANG_DIR}/lua
WWW_LANG_PY_DIR=${WWW_LANG_DIR}/python
WWW_LANG_JV_DIR=${WWW_LANG_DIR}/java
WWW_LANG_HTML_DIR=${WWW_LANG_DIR}/html

APP_DIR=${SYNC_DIR}/applications
APP_BOOTS_DIR=${APP_DIR}/boots
APP_BOOTS_CDA_DIR=${APP_BOOTS_DIR}/conda
APP_BOOTS_SUP_DIR=${APP_BOOTS_DIR}/supervisor
APP_BOOTS_DOC_DIR=${APP_BOOTS_DIR}/docker
APP_INIT_DIR=${APP_DIR}/init
APP_INIT_MSQ_DIR=${APP_INIT_DIR}/mysql
APP_INIT_MDB_DIR=${APP_INIT_DIR}/mariadb
APP_INIT_PSQ_DIR=${APP_INIT_DIR}/postgresql
APP_INIT_MGDB_DIR=${APP_INIT_DIR}/mongodb
APP_INIT_CH_DIR=${APP_INIT_DIR}/clickhouse
APP_LANG_DIR=${APP_DIR}/lang
APP_LANG_LUA_DIR=${APP_LANG_DIR}/lua
APP_LANG_PY_DIR=${APP_LANG_DIR}/python
APP_LANG_GO_DIR=${APP_LANG_DIR}/go
APP_LANG_SH_DIR=${APP_LANG_DIR}/shell
